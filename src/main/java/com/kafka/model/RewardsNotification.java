...
public class RewardsNotification {
    ...
    public RewardsNotification withInvoiceNumber(String invoiceNumber) {
        this.invoiceNumber = invoiceNumber;
        return this;
    }
    ...
    public RewardsNotification withCustomerCardNo(String customerCardNo) {
        this.customerCardNo = customerCardNo;
        return this;
    }
    ...
    public RewardsNotification withTotalAmount(Double totalAmount) {
        this.totalAmount = totalAmount;
        return this;
    }
    ...
    public RewardsNotification withEarnedLoyaltyPoints(Double earnedLoyaltyPoints) {
        this.earnedLoyaltyPoints = earnedLoyaltyPoints;
        return this;
    }
    ...
    public RewardsNotification withTotalLoyaltyPoints(Double totalLoyaltyPoints) {
        this.totalLoyaltyPoints = totalLoyaltyPoints;
        return this;
    }
